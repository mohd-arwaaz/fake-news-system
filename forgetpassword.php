<?php
session_start();
$conn = new mysqli("localhost", "root", "prince143", "books"); // change if needed
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reset'])) {
    ...
    $stmt = $conn->prepare("SELECT username FROM fakenews WHERE username = ?");
